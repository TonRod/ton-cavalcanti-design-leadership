/**
 * Marca do Medium. O lucide não traz ícones de marca além dos mais comuns,
 * então o desenho vem inline — em currentColor, para acompanhar o tema e
 * ficar do mesmo peso visual dos demais ícones da linha de contato.
 */
