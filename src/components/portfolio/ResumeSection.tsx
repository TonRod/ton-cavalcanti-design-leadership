...
/** Troque para `true` para voltar a exibir o card de download do currículo. */
  ...
  return (
    <section id="curriculo" className="border-t border-border py-16">
      <div className="mx-auto w-full max-w-6xl px-6">
        <p className="kicker">
          {SHOW_CV_DOWNLOAD ? "Currículo e formação" : "Formação"}
        </p>
        ...
        <p className="mt-4 max-w-2xl font-serif text-sm leading-relaxed text-muted-foreground">
          {SHOW_CV_DOWNLOAD
            ? "Esta página traz uma seleção. Aqui está o resto — o histórico profissional completo e a formação acadêmica."
            : "Esta página traz uma seleção. Aqui está o resto — a formação acadêmica e as certificações."}
        </p>

        <div
          className={
            SHOW_CV_DOWNLOAD ? "mt-8 grid gap-5 sm:grid-cols-2" : "mt-8 grid max-w-xl gap-5"
          }
        >
          {SHOW_CV_DOWNLOAD && (
